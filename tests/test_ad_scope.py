...
def test_resolver_keeps_auto_and_manual_as_sp_when_route_scope_is_sp():
    ...
    campaigns = [
        {
            "campaign_id": "auto-1",
            "campaign_name": "VC_B0GXYYZPBW_Auto_Close",
            "targeting_type": "auto",
        },
        {
            "campaign_id": "manual-1",
            "campaign_name": "VC_B0GXYYZPBW_manual_keyword",
...
def test_resolver_excludes_sb_sd_from_sp_but_keeps_them_in_all_ads():
    ...
    campaigns = [
        {
            "campaign_id": "sp-1",
            "campaign_name": "LH-B0GXYYZPBW-SP-exact",
            "spend": 30,
            "sales": 90,
        },
        {
            "campaign_id": "sb-1",
            "campaign_name": "LH_B0GXYYZPBW_SB_brand",
            "spend": 20,
            "sales": 40,
        },
        {
            "campaign_id": "sd-1",
            "campaign_name": "LH_B0GXYYZPBW_SD_retarget",
            "spend": 10,
            "sales": 15,
        },
    ]
...
def test_unknown_campaign_stays_in_all_ads_with_unknown_status():
    ...
    campaign = {
        ...
        "campaign_name": "LH_B0GXYYZPBW_launch",
        "spend": 12,
    }
